...
class Ui_Dialog_Tables(object):
    def setupUi(self, Dialog_Tables):
        ...
        Dialog_Tables.setStyleSheet("background-color: rgb(255, 255, 0);")
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(100, 120, 101, 23))
...
"background-color: rgb(0, 0, 0);")
        ...
        self.label_3 = QtWidgets.QLabel(Dialog_Tables)
        self.label_3.setGeometry(QtCore.QRect(10, 400, 261, 16))
    ...
    def retranslateUi(self, Dialog_Tables):
        ...
        Dialog_Tables.setWindowTitle(_translate("Dialog_Tables", "Tаблиці"))
        self.label_2.setText(_translate("Dialog_Tables", "                   Таблиці"))
        self.pushButton.setText(_translate("Dialog_Tables", "Статистичні дані"))
        self.pushButton_2.setText(_translate("Dialog_Tables", "Довідник ринків"))
        self.pushButton_3.setText(_translate("Dialog_Tables", "Аналіз середніх цін"))
        self.pushButton_4.setText(_translate("Dialog_Tables", "Вихід"))
        self.label_3.setText(_translate("Dialog_Tables", "Роботу виконав:Гайдай Назар (1-7 ФІТ)"))
